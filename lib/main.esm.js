...
*/
function transformQueryAttrtoArray(queryObj, keys) {
    var QObj = __assign({}, queryObj);
...
function objectHandler(attrPath, value, rule) {
    ...
    if (!rule.allowOtherKeys) {
        ...
        objKeys.forEach(function (key) {
            var pathStr = joinAttrPath(__spread(attrPath, [String(key)]));
...
function HandlerSwitch(attrPath, value, rule) {
    ...
    switch (rule.type) {
        ...
        case "number":
            ...
            break;
        case "boolean":
            err = booleanHandler(attrPath, value);
            break;
        case "any":
            err = anyHandler(attrPath, value);
            break;
        case "array":
...
function jsonBodyCheck(rootRule) {
    ...
    return function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, isJSONBody(ctx)];
                case 1:
...
function queryCheck(rules) {
    ...
    return function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    qobj = transformQueryAttrtoArray(ctx.query, rules.filter(function (i) { return i.type === "array"; }).map(function (i) { return i.key; }));
                    queryObjectRule = {
                        type: "object",
...
export { jsonBodyCheck, queryCheck };
